(function (angular) {
    ...
    var psadmin = angular.module('psadmin', ['ngMaterial', 'ps.sync']);
    ...
    psadmin.controller('AdminCtrl', function ($scope, $rootScope, $mdDialog, $q) {
        ...
        $scope.promptCompetition = function (ev) {
            ...
            $mdDialog.show({
                targetEvent: ev,
                templateUrl: 'templates/competitionDialog.html',
        ...
        $scope.promptGroup = function (ev, competition) {
            ...
            $mdDialog.show({
                targetEvent: ev,
                templateUrl: 'templates/groupDialog.html',
                locals: {group: group},
        ...
        $scope.promptParticipant = function (ev, group, knownParticipant) {
            ...
            $mdDialog.show({
                targetEvent: ev,
                templateUrl: 'templates/participantDialog.html',
